...
CategoryDao catDao = new CategoryDao(DBConnection.getConnection());
...
.custom-color {
	background: radial-gradient(circle, rgb(241, 250, 218) 0%, rgb(158, 200, 185) 24%, rgb(154, 208, 194) 49%, rgb(45, 149, 150) 86%, rgb(38, 80, 115) 100%);
}
</style>
<nav class="navbar navbar-expand-lg custom-color" data-bs-theme="dark">
	...
	<div class="container">
		<a class="navbar-brand" href="admin.jsp"><i
			class="fa-sharp fa-solid fa-light fa-book" style="color: #ffffff;"> &nbsp; Book Store</i>&ensp;
