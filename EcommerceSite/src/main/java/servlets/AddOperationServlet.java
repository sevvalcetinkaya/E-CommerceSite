...
import com.cds.dao.CategoryDao;
import com.cds.dao.ProductDao;
import com.cds.entities.Category;
...
public class AddOperationServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (operation.trim().equals("addCategory")) {
			...
			Product product = new Product(pName, pDesc, pPrice, pQuantity, part.getSubmittedFileName(),
					categoryType);
			...
			if (part.getSubmittedFileName().isEmpty()) {
				...
				Product product = new Product(pid, name, description, price, quantity,
